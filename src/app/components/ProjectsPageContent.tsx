...
const ProfileSection: React.FC = () => (
  <Link href="/" className="flex gap-8 items-center justify-start group">
    <div className="flex flex-col gap-[6px] justify-center items-start">
      <motion.h1
        className="text-2xl md:text-3xl font-medium tracking-tight leading-tight text-surface-dark-foreground group-hover:text-accent transition-all duration-300"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
