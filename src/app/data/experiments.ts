...
export const experimentRegistry: ExperimentMeta[] = [
  {
    ...
    tags: ['Interaction Design', 'Spatial UX'],
    order: 7,
    type: 'experiment',
    showInPreview: false,
  },
  {
    ...
    tags: ['iOS Engineering', 'Health Tech'],
    order: 3,
    type: 'experiment',
  },
  {
  ...
  },
  {
    ...
    tags: ['UX Research', 'Consumer Product'],
    order: 4,
    type: 'experiment',
  },
  {
    ...
    tags: ['UX Research', 'Productivity Tools'],
    order: 5,
    type: 'experiment',
    showInPreview: false,
  },
