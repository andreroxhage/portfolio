...
export const resume = [
	{
		...
		content: [
			{
				subtitle: 'Master in Engineering, Information & Communication Technologies',
	...
	},
	{
		...
		content: [
			...
			{
				subtitle: 'Marketing Manager & Graphic Designer for a volunteer organization',
	...
	},
	{
		...
		content: [
			...
			},
			{
				...
				items: ['React, Vue, TypeScript, Tailwind, Bootstrap, Java SQL, and Python'],
			},
			{
