...
export default function Footer() {
  return (
    <footer className="bg-surface-footer overflow-x-hidden">
      <div className="max-w-8xl mx-auto pt-8 sm:pt-12 md:pt-16 px-5 sm:px-6 md:px-4">
        ...
        <div className="flex flex-col-reverse sm:flex-row gap-12 pt-16 sm:pt-12 pb-4 mt-8">
          <a className="flex w-3/4 items-end flex-row py-2" href={'#header'}>
            <span className="text-foreground md:text-base text-sm font-medium mr-2">
