...
export default function Contact() {
  ...
  return (
    <div id="contact" className="h-screen bg-secondary p-0 lg:p-12 lg:py-18">
      <div
        ...
        style={{
          ...
          boxShadow:
            'inset 0 0 0 1px rgba(255,255,255,0.05), inset 0 6px 20px rgba(0,0,0,0.35)',
        }}
      >
        <div className="flex flex-col justify-between overflow-hidden w-full h-full">
          ...
          >
            ...
            >
              <div className="max-w-8xl mx-auto relative flex items-center w-full h-full overflow-hidden">
                <motion.h2
            ...
            <div
              id="contact-info"
              className="relative z-30 px-5 sm:px-6 md:px-4"
            >
              <div className="max-w-8xl w-full mx-auto pb-8">
                <div className="inline-flex flex-col gap-y-2 text-surface-dark-foreground">
                  <hr className="h-0.5 pt-2 border-border/70 w-52 md:w-64" />
