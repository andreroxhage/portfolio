		...
		<>
			...
			>
				<div className='flex flex-col justify-between overflow-hidden w-full h-screen'>
					<div id='footer-container' className='w-full h-4/6 overflow-hidden py-14'>
						<FollowerPointerCard title={<TitleComponent title={'Connect'} />} className='h-full z-40'>
					...
					<div id='contact-info' className='px-4 max-w-7xl w-full mx-auto overflow-hidden h-2/6'>
