...
import { AnimatePresence, easeInOut, motion, useInView, useScroll, useTransform } from 'framer-motion';
		...
		>
			<div ref={container} className='max-w-7xl mx-auto h-full px-4 mt-8 md:pt-12 mb-8 md:mb-16 pt-4'>
				...
				<div className='gap-x-8 mt-9 bg-primary-vanilla rounded-xl  grid grid-cols-10 text-2xl  text-primary-grey-brighter items-center'>
					...
					>
						<Image className='h-full w-full rounded-sm' src={mockup} alt='image description' />
					</ScrollScaleWrapper>
				</div>
			</div>
			...
			<div className='mx-auto h-full px-4 w-full flex flex-col items-center justify-center overflow-hidden rounded-md'>
				<motion.div
					...
					viewport={{ once: true }}
				>
					<TextRevealCard text='Are You a LinkedIn Stalker?' revealText='Feel free to read!'></TextRevealCard>
				</motion.div>
