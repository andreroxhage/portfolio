...
import karneval1 from '../../../public/resource/work/karneval1.png';
import karneval2 from '../../../public/resource/work/karneval2.png';
			...
			<div className='h-fit my-auto md:pt-0 flex-row items-center relative pb-16'>
				<div className='mx-auto h-full grid grid-cols-10 text-2xl text-primary-grey-brighter items-center'>
					<motion.div className='col-start-1 col-span-5 relative'>
						<Image
							className='w-30 absolute top-[16%] left-[22%] z-20'
							src={karneval1}
							alt='image description'
						/>
						<Image
							className='w-30 absolute top-[42%] left-[42%] z-30'
							src={karneval2}
							alt='image description'
						/>
					...
					>
						<div className='flex flex-col gap-x-6 justify-center items-start w-full h-full'>
							<h5 className='text-xl md:text-3xl font-semibold pb-1 md:pb-4'>
								{VoluntaryProjects[0].title}
							</h5>
							<p className='text-base md:text-lg font-medium max-w-[700px]'>
