...
export default function Photography() {
  return (
    ...
    >
      <div className="max-w-8xl mx-auto w-full grid grid-cols-10 px-5 sm:px-6 md:px-4 md:py-40 py-16 sm:py-20 mb-16 sm:mb-20 md:mb-12">
        <div className="col-span-10 lg:col-span-5 lg:col-start-2 flex flex-col gap-y-4">
          <motion.h3
            className="text-foreground text-xl md:text-4xl font-medium"
