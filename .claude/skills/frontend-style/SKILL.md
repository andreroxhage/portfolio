---
name: frontend-style
description: Design system guide for the portfolio. Read before writing any styled code.
origin: portfolio
---
...
<div class="rounded-[40px] corner-squircle">  <!-- Large: dialogs, videos -->
<div class="rounded-[12px] corner-squircle">  <!-- Medium: cards, panels -->
<div class="rounded-[8px] corner-squircle">   <!-- Small: badges, tags -->
<div class="rounded-[2px] corner-squircle">   <!-- Minimal: images, thumbnails -->
```
